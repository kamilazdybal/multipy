...
class Flux(unittest.TestCase):
    ...
    def test_Flux__diffusive_mass_molar__allowed_calls(self):
        ...
        try:
            ...
            get_df = flux.get_diffusive_mass_molar
...
################################################################################
    ...
    def test_Flux__diffusive_mass_molar__not_allowed_calls(self):
...
################################################################################
    ...
    def test_Flux__diffusive_mass_molar__computation(self):
