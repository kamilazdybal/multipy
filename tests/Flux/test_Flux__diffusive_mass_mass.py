...
class Flux(unittest.TestCase):
    ...
    def test_Flux__diffusive_mass_mass__allowed_calls(self):
        ...
        try:
            ...
            get_df = flux.get_diffusive_mass_mass
...
################################################################################
    ...
    def test_Flux__diffusive_mass_mass__not_allowed_calls(self):
...
################################################################################
    ...
    def test_Flux__diffusive_mass_mass__computation(self):
